...
public class Random_moshi extends Activity{
...
//						String fenshu="<font color='#222222'><small>分数</small><font>";
					 ...
					 if(count==10){
						 Toast.makeText(Random_moshi.this,"距离超神还有10道", Toast.LENGTH_SHORT).show();
					 }
					 if(count==20){
							alter() ;
						}
	 ...
	 */
			private void alter() {
				android.app.AlertDialog.Builder build=new AlertDialog.Builder(Random_moshi.this);
				   ...
				   build.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					build.setNegativeButton("取消",new android.content.DialogInterface.OnClickListener(){
						...
						public void onClick(DialogInterface dialog, int which) {						
							Random_moshi.this.finish();	
							intent=new Intent();
							intent.setClass(Random_moshi.this, Level.class);
	...
	private void init() {
		...
		Drawable btnDrawable = resources.getDrawable(R.drawable.t7);  
